...
summarise(evals, median(score))
```

*Add your other details and narratives here.*
The graph is skewed to the right which would suggest that the median is lower than the mean. This is true mean = 4.17473 and median = 4.3. Students tend to rate courses quite highly with lower scores being outlyers.
...
Jitter makes all the points that were overlapping to be visable. The old graph will less representative of the actually data because not all data can be seen.
...
score = 3.88033795 + 0.06663704 * bty_avg
